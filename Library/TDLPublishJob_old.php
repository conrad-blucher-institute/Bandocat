...
class TDLPublishJob
{
    ...
    public function TDL_POST_BITSTREAM($itemID,$path,$file)
    {
		...
		curl_setopt($ch,CURLOPT_POST,true);
		$header = array('cookie: JSESSIONID=' . $this->token,'Content-Type:application/json', 'Accept:application/json');
		curl_setopt($ch,CURLOPT_HTTPHEADER,$header);
  ...
  /*   //delete_item
    ...
    public function TDL_DELETE_ITEM($itemID,$certUrl = null)
    {
		...
		curl_setopt($ch,CURLOPT_CUSTOMREQUEST,"DELETE");
		$header = array('cookie: JSESSIONID=' . $this->token, 'Accept:' . $mime );
        curl_setopt($ch,CURLOPT_HTTPHEADER,$header);	
        curl_setopt($ch, CURLOPT_RETURNTRANSFER,true);
		curl_setopt($ch,CURLOPT_HEADER,true);
		curl_setopt($ch,CURLOPT_CUSTOMREQUEST,"DELETE");
    ...
    public function TDL_DELETE_ITEM($itemID,$mime,$certUrl = null)
    {
		...
		curl_setopt($ch, CURLOPT_URL,$this->baseUrl . "items/" . $itemID);
		curl_setopt($ch,CURLOPT_CUSTOMREQUEST,"DELETE");
		$header = array('cookie: JSESSIONID=' . $this->token,'Content-Type:' . $mime, 'Accept: ' . $mime );
        curl_setopt($ch,CURLOPT_HTTPHEADER,$header);	
        curl_setopt($ch, CURLOPT_RETURNTRANSFER,true);
		curl_setopt($ch,CURLOPT_HEADER,true);
		curl_setopt($ch,CURLOPT_CUSTOMREQUEST,"DELETE");

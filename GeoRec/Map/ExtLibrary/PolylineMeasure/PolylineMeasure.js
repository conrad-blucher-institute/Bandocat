(function() {
    ...
    L.Control.PolylineMeasure = L.Control.extend({
        ...
        _startMeasuring: function() {
            //Added flag to check for measuring mode
            var self = this;
            self._measureModeSet(true);
            self._changeCursor();
        ...
        _measureModeSet: function(bool) {
            self.boolMeasureMode = bool;
        },
        _measureModeGet: function() {
            return self.boolMeasureMode;
        },
        /**
        ...
        _measureMarkerGet: function() {
            return self.measureMarker;
        },
    ...
    L.Control.PolylineMeasure.include({
        _measureMode: function InMesureMode(mode, contents) {
            if(self._measuring)
                mode = true;
            this.mode = mode;
        }

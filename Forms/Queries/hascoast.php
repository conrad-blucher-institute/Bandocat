                    ...
                    <table width="100%">
                        <tr>
                            ...
                            <td style="float:left;font-size:13px" colspan="20%">
                                ...
                                <?php
                                $link = mysql_connect("localhost","root","notroot");
                                mysql_select_db("maps", $link);
...
<script>
    var counter = <?php echo json_encode($hascoast_rows); ?>;
    var total = <?php echo json_encode($totnum_rows); ?>;
    var percentage = counter/total * 100;

...
<head>
    ...
    <link rel = "stylesheet" type = "text/css" href = "../../Forms/Statistics/css/master.css" >
    ...
    <script type ="text/javascript" src ="js/projects-widget.js"> </script>
    <script type="text/javascript" src="js/fireworks.js"></script>
    <script type="text/javascript" src="js/showControls.js"></script>

</head>
<body>

<audio id="clap" hidden="" src="applause3.mp3" controls></audio>
<div id="wrap">
    <div id="main">
        <div id="divleft">
            ...
            <div id="divscroller">
                <table><tr>
                        ...
                        <td style="padding-left:60px;vertical-align: top">
                            ...
                            <div class="pulse" id="displayTotal">Total: 100,000 documents  </div>
                            <div id="storage_capacity">
                                ...
                                <div id="storage_info" style="border-size: 1px; border-width: thin; border-style:solid; border-color:LightGray; padding:5px">
                                    <div class="storagecap">Blucher Maps: 821.03 GB</div>
								<div class="storagecap">Green Maps: 314.99 GB</div>
								<div class="storagecap">Job Folder: 292.77 GB</div>
								<div class="storagecap">Blucher Field Book: 974.12 GB</div>
								<div class="storagecap">Map Indices: 101.64 GB</div>
								<div class="storagecap">PennyFenner: 53.01 GB</div>
								<div class="storagecap">Field Book Indices: 0 B</div>
								<div class="storagecap"><b>All Collections:2.49 TB</b></div>
								<div class="storagecap">Disk Free Space: 3.55 TB</div></div>
                                </div>
                            </div>
                        </td>
                    </tr>
...
<div id="audioDiv">
    <audio id="music" class="musicControl" controls></audio>
    <audio id="fireworkSounds" class="musicControl"></audio>
</div>
...
//                }
    ...
    $(document).ready(function()
    {
        ...
        //$("#ddlYear").change();
        getCollectionCount();
        $.get('ajax/calculatefilesize_processing_fast.php', function(data)
        {
            console.log(data);

                    ...
                    <tr >
                        ...
                        <td     id = mapStatGroup style = " vertical-align:top; margin-left:60px; float:right ;  ">
                            ...
                            <div id = mapColumn     ">
                                ...
                                ></canvas>
                                <div class="pulse" id="displayTotal" style = "margin-top: 20px;" >Total: <span id="spanTotalCount"></span> Documents  </div>
                        ...
                        <td style = "; vertical-align: top; align-content: center;">
                            ...
                            <table style = "margin-left: 15%; vertical-align: top;">
                                <tr  >
                                    <td ><div class = "BlucherMapsLabel"</td> <td>Blucher Maps</td>
